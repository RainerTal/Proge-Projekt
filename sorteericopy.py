        ...
        messages=[
            {
                ...
                Make a CSV compatible list with label Kategooria,Kuupäev,Firma,Summa,Valuuta. Firma should be as short as possible. Separate categories and have payments in this form: Toidukaubad,08.12.2023,GROSSI TOIDUKAUBAD,-26.35,EUR
                """
            },
            {
                "role": "user",
...
def visualiseeri_seb(sisend_fail):
    fail = sisend_fail

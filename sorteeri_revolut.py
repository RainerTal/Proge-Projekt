...
def kirjuta_tagasi(fail, api_response):
    with open(fail, "w", encoding="utf-8") as f:
        print(f"{api_response}", file=f)
...
def main():
    ...
    korrastatud = (korista_list_REVOLUT())
    
    esimene_pool, teine_pool = jaga_topeltlist_kaheks(korrastatud)
